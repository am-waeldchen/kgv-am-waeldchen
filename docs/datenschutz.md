...
Alle Datenverarbeitungsvorgänge auf dieser Website erfolgen im Einklang mit den datenschutzrechtlichen gesetzlichen Vorschriften, insbesondere mit der Datenschutz-Grundverordnung (DSGVO) und dem Bundesdatenschutzgesetz (BDSG).
...
Auf dieser Webseite werden keine sogenannten Cookies verwendet.
